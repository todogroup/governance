...
. *Steering Committee:*
.. The Steering Committee shall be composed of five (5) General Members, selected for their expertise, contribution to the advancement of open source program management.
