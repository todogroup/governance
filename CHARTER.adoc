...
. *Topic Discussion Groups (TDG)*
A Topic Discussion Group is a community discussion space for exploring ideas, sharing perspectives, and developing topics at an early stage.
. *Working Groups (WG)*
A Working Group is a group of community participants responsible for developing and maintaining a specific artifact or output, such as documentation, frameworks, reference implementations, or other recurring deliverables.
